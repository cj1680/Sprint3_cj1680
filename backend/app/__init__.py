...
from app.routes import graph_route, geometry_route, algebra_route, wordproblem_route, login, register, login_token, history_route, deleteConvo_route, ping_route
...
def create_app():
    ...
    app.register_blueprint(ping_route.bp)
    return app